...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form action="adminInsertCourse" method="post">	
                	<div >
                		<label>课程编号</label>
                		<font color="red">*</font>
        ...
        <table  class="table table-striped table-bordered table-hover" >
            <tr  >
                ...
                <td>删除操作</td>
                 ...
                 List<Course> courses =(List<Course>) session.getAttribute("AdminListCourse");
                int i = 0;
				for(Course course:courses){
					
				%>
					<form action="adminDeleteCourse" method="post"> 
					<tr id="tr<%= i%>">            
					<td ><input style='width:15vw; border-left:0px;border-top:0px;border-right:0px;border-bottom:0px;background-color:transparent; ' type="text" readonly="readonly" id="studentId_delete" name="studentId_delete" value="<%=course.getId()%>" /> </td>
                	<td><input style='width:15vw; border-left:0px;border-top:0px;border-right:0px;border-bottom:0px;background-color:transparent; ' type="text" readonly="readonly" id="studentName_delete" name="studentName_delete" value="<%=course.getName()%>" /> </td>
                	<td><input style='width:15vw; border-left:0px;border-top:0px;border-right:0px;border-bottom:0px;background-color:transparent; ' type="text" readonly="readonly"  id="courseName_delete" name="courseName_delete" value="<%=course.getTeacher()%>" /> </td>
