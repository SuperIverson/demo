...
<button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#addStudentModal">
    新增学生信息
</button>
<!-- 模态框（Modal） -->
...
<%--              <%
			...
			%> --%>	
			<form action="adminInsertStudent" method="post">	
                	<div >
                		<label>学生学号</label>
                		<font color="red">*</font>
	...
	<!-- 模态框（Modal） -->
<div class="modal fade" id="changeStudentModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
            ...
            <div class="modal-body">
			    ...
			    if(cookies!=null){
			    	for(Cookie cookie:cookies){
			    		if("stuId_change".equals(cookie.getName())){
        ...
        <table  class="table table-striped table-bordered table-hover" >
            <tr  >
                ...
                <td>删除操作</td>
                 ...
                 List<Student> students =(List<Student>) session.getAttribute("AdminListStudent");
                int i = 0;
				for(Student student:students){
					
					%>
					<form action="adminDeleteStudent" method="post"> 
					<tr id="tr<%= i%>">            
					<td ><input style='width:10vw; border-left:0px;border-top:0px;border-right:0px;border-bottom:0px;background-color:transparent; ' type="text" readonly="readonly" id="studentId_delete" name="studentId_delete" value="<%=student.getId()%>" /> </td>
                	<td><input style='width:10vw; border-left:0px;border-top:0px;border-right:0px;border-bottom:0px;background-color:transparent; ' type="text" readonly="readonly" id="studentName_delete" name="studentName_delete" value="<%=student.getName()%>" /> </td>
                	<td><input style='width:10vw; border-left:0px;border-top:0px;border-right:0px;border-bottom:0px;background-color:transparent; ' type="text" readonly="readonly"  id="courseName_delete" name="courseName_delete" value="<%=student.getPassword()%>" /> </td>
                	<td><button type="button"  name="change" data-toggle="modal" data-target="#changeStudentModal" onclick="f1(this)">修改</button>  </td>
